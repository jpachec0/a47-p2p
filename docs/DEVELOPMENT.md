...
The test suite includes unit tests for config, path handling, error output, and transfer protocol helpers, plus integration tests for the signaling relay, hash mismatch cleanup, and a small WebRTC DataChannel file transfer.
