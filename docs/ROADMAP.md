...
Phases 1 through 14 have an MVP implementation path. Release tags `v0.1.0`, `v0.1.1`, `v0.1.2`, `v0.1.3`, and `v0.1.4` have been published with Windows, Linux, macOS, and installer assets through GitHub Actions.
